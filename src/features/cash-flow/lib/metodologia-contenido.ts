...
export const MOTOR_CAMBIO_MENSUAL = [
  ...
  },
  {
    ...
    explicacion:
      "Sube o baja principalmente porque cambia la DOTACIÓN, no el costo por persona (que se mantiene FIJO — promedio de los últimos 3 meses reales, sin beneficios): Remuneración ≈ costo base por cabeza × dotación del mes actual + Beneficios pagados con Remuneración del propio mes (aporte sindical, gift cards). Si la dotación crece 5%, Remuneración proyectada crece ≈5% en el mismo sentido. Los aguinaldos de septiembre/diciembre NO están acá — se pagan con el Anticipo.",
  },
  {
    concepto: "Anticipo",
    explicacion:
